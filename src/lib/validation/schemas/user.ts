...
// Keys vigentes (post-eliminación de Bienestar, Life OS, Organización,
// Meditación en 2026-04). Nota: aceptamos keys legacy (mood/sleep/
// hydration/medications/journal/projects/fasting/pregnancy/meditation/
// organization) en el enum de entrada para no rechazar perfiles viejos
// en migración, pero el server los filtra al leer.
const INTEREST_KEYS = [
  "training", "nutrition", "finance", "productivity",
  "study", "reading", "fasting", "menstrualCycle", "pregnancy", "none",
  // legacy — aceptadas por compat, se filtran al leer
  "mindfulness", "sleep", "hydration", "medications",
] as const;
const MODULE_KEYS = [
  "home", "habits", "tasks", "settings", "gamification",
  "fitness", "nutrition", "finance", "planner",
  "reading", "menstrualCycle",
  // legacy — aceptadas por compat, se filtran al leer
