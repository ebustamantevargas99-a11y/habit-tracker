...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Mostrar el botón de Google solo si el provider está configurado.
            ...
            {googleAvailable && (
              <>
                <div className="flex items-center gap-3 py-1">
                  <span className="flex-1 h-px bg-brand-cream" />
                  <span className="text-[11px] text-brand-warm">o</span>
                  <span className="flex-1 h-px bg-brand-cream" />
                </div>
                <button
                  type="button"
                  ...
                  disabled={loading}
                  className="w-full py-3 rounded-[10px] font-semibold text-sm transition-all bg-white border border-brand-cream text-brand-dark hover:bg-brand-warm-white disabled:opacity-50 flex items-center justify-center gap-2.5 shadow-sm"
                >
